...
function Blacklib:Window(gametitle)
    ...
    local function UpdateOS()
        ...
        osfunc:Refresh("时间 : " .. timezone)
        osfunc2:Refresh("时期 : " .. datetime .. " [全球统一时间]")
    end
    spawn(function()
        while true do
            UpdateOS()
    ...
    function Tabs:Tab(tabtitle, img)
        ...
        function Section:NewSection(seclabel)
            ...
            closeSection.Text = "放大"
            closeSection.TextSize = 18.000
